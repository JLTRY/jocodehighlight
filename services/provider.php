...
use JLTRY\Plugin\Content\JOCodeHighlight\Extension\JOCodeHighlight;
     ...
     public function register(Container $container)
        {
            $container->set(
                ...
                function (Container $container) {
                    $config = (array)PluginHelper::getPlugin('content', 'jocodehighlight');
                    $subject = $container->get(DispatcherInterface::class);
                    $app = Factory::getApplication();
                    $plugin = new JOCodeHighlight($subject, $config);
